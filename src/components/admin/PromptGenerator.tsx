...
const PromptGenerator = () => {
    ...
    const handleGenerate = (e: React.FormEvent) => {
        ...
        const promptTemplate = `Actúa como Analista Metabólico y Lead Prompt Engineer.
    ...
    return (
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 shadow-2xl flex flex-col h-full relative overflow-hidden">
            ...
            <form onSubmit={handleGenerate} className="flex flex-col gap-4 mb-6">
                <div>
                    <label className="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-2 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
