...
- REGLA DE ORO VISUAL (image_prompts): Cero Solapamiento. Genera descripciones para DALL-E 3 en inglés que capturen un momento específico o una analogía exacta mencionada en la transcripción. Prohibido usar descripciones estándar como 'a person exercising' o 'healthy food'. Usa detalles únicos del video (ej. 'A measuring tape glowing at the navel level'). ESTRICTAMENTE PROHIBIDO INCLUIR TEXTO, LETRAS O ETIQUETAS en la imagen. Deben ser metáforas visuales limpias, estilo 'render 3D isométrico minimalista' o 'fotografía conceptual de estudio'. Usa códigos de color (ej. rojo=mal, azul=bien) para explicar conceptos sin palabras.
